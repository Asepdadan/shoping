...
class Wanita_kaos extends CI_Controller {
        ...
        $this->image_lib->watermark();
         ...
         public function wanita_kaos(){
            $data['title'] = "Produk";
            $data['data'] = $this->Model_wanita->wanitaKaos();
            $data['title'] = "Input Produk kaos wanita";
            $data['header'] = "Produk kaos wanita";

            $this->load->view('admin/layout/header',$data);
            $this->load->view('admin/layout/menu');
            $this->load->view('admin/kategori/wanita/kaos_wanita',$data);
             ...
             $stok = $this->input->post('stok');
              ...
              $this->load->library('form_validation');          
                ...
                if ($this->form_validation->run() == FALSE)
                {
                      ...
                      $this->load->view('admin/layout/header',$data);
                      $this->load->view('admin/layout/menu');
                      $this->load->view('admin/kategori/kaos_wanita',$data);
                      $this->load->view('admin/layout/footer');
                }
                else
                {
        ...
        public function editkaos($kode){
            ...
            $this->load->view('admin/layout/header',$data);
            $this->load->view('admin/layout/menu');
            $this->load->view('admin/kategori/edit_wanita/edit_kaos',$data);
            $this->load->view('admin/layout/footer');
          }
