...
class Wanita_jaket extends CI_Controller {
        ...
        $this->image_lib->watermark();
         ...
         public function wanita_jaket(){
            $data['title'] = "Produk";
            $data['data'] = $this->Model_wanita->wanitajaket()
            $data['title'] = "Input Produk jaket wanita";
            $data['header'] = "Produk jaket wanita";

            $this->load->view('admin/layout/header',$data);
            $this->load->view('admin/layout/menu');
            $this->load->view('admin/kategori/wanita/jaket_wanita',$data);
        ...
        public function editjaket($kode){
            ...
            $this->load->view('admin/layout/header',$data);
            $this->load->view('admin/layout/menu');
            $this->load->view('admin/kategori/edit_wanita/edit_jaket',$data);
            $this->load->view('admin/layout/footer');
          }
