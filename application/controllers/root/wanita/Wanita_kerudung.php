...
class Wanita_kerudung extends CI_Controller {
        ...
        $this->image_lib->watermark();
         ...
         public function wanita_kerudung(){
            $data['title'] = "Produk";
            $data['data'] = $this->Model_wanita->wanitaKerudung();
            $data['title'] = "Input Produk kerudung wanita";
            $data['header'] = "Produk kerudung wanita";

            $this->load->view('admin/layout/header',$data);
            $this->load->view('admin/layout/menu');
            $this->load->view('admin/kategori/wanita/kerudung_wanita',$data);
            $this->load->view('admin/layout/footer');


        }

        public function action_kerudung(){
             ...
             $stok = $this->input->post('stok');
              ...
              $this->load->library('form_validation');          
                ...
                if ($this->form_validation->run() == FALSE)
                {
                      ...
                      $this->load->view('admin/layout/header',$data);
                      $this->load->view('admin/layout/menu');
                      $this->load->view('admin/kategori/kerudung_wanita',$data);
                      $this->load->view('admin/layout/footer');
                }
                else
                {
                       ...
                       'stok' => $stok,
                        ...
                        'warna' => $warna,
                         'deskripsi' => $deskripsi,
                          ...
                          redirect('wanita_kerudung');       
            }
          }

        }

              public function deletekerudung($kode){
        ...
        public function editkerudung($kode){
         
            $data['title'] = "Input Produk kerudung wanita";
            $data['header'] = "Edit Produk kerudung";
            $data['data'] = $this->Model_wanita->getWhere($kode);
            $this->load->view('admin/layout/header',$data);
            $this->load->view('admin/layout/menu');
            $this->load->view('admin/kategori/edit_wanita/edit_kerudung',$data);
            $this->load->view('admin/layout/footer');
          }

          public function action_edit_kerudung(){
