...
class Wanita_atasan extends CI_Controller {
        ...
        $this->image_lib->watermark();
         ...
         public function wanita_atasan(){
            $data['title'] = "Produk";
            $data['data'] = $this->Model_wanita->wanitaAtasan();
            $data['title'] = "Input Produk atasan wanita";
            $data['header'] = "Produk atasan wanita";

            $this->load->view('admin/layout/header',$data);
            $this->load->view('admin/layout/menu');
            $this->load->view('admin/kategori/wanita/atasan_wanita',$data);
            $this->load->view('admin/layout/footer');


        }

        public function action_atasan(){
                       ...
                       'stok' => $stok,
                        ...
                        'warna' => $warna,
                         'deskripsi' => $deskripsi,
                          ...
                          redirect('wanita_atasan');       
            }
          }

        }

              public function deleteatasan($kode){
        ...
        public function editatasan($kode){
         
            $data['title'] = "Input Produk atasan wanita";
            $data['header'] = "Edit Produk atasan";
            $data['data'] = $this->Model_wanita->getWhere($kode);
            $this->load->view('admin/layout/header',$data);
            $this->load->view('admin/layout/menu');
            $this->load->view('admin/kategori/edit_wanita/edit_atasan',$data);
            $this->load->view('admin/layout/footer');
          }

          public function action_edit_atasan(){
