...
class Wanita_gamis extends CI_Controller {
        ...
        $this->image_lib->watermark();
         ...
         public function wanita_gamis(){
            $data['title'] = "Produk";
            $data['data'] = $this->Model_wanita->wanitaGamis();
            $data['title'] = "Input Produk gamis wanita";
            $data['header'] = "Produk gamis wanita";

            $this->load->view('admin/layout/header',$data);
            $this->load->view('admin/layout/menu');
            $this->load->view('admin/kategori/wanita/gamis_wanita',$data);
            $this->load->view('admin/layout/footer');


        }

        public function action_gamis(){
              ...
              $this->load->library('form_validation');          
                ...
                else
                {
                      ...
                      $data['header'] = "Produk gamis wanita";
                            ...
                            $this->load->view('admin/layout/header',$data);
                          $this->load->view('admin/layout/menu');
                          $this->load->view('admin/kategori/gamis_wanita',$data);
                          $this->load->view('admin/layout/footer');
                      }
                      else
                      {
                       ...
                       'stok' => $stok,
                        ...
                        'warna' => $warna,
                         'deskripsi' => $deskripsi,
                          ...
                          redirect('wanita_gamis');       
            }
          }

        }

              public function deletegamis($kode){
        ...
        public function editgamis($kode){
         
            $data['title'] = "Input Produk gamis wanita";
            $data['header'] = "Edit Produk gamis";
            $data['data'] = $this->Model_wanita->getWhere($kode);
            $this->load->view('admin/layout/header',$data);
            $this->load->view('admin/layout/menu');
            $this->load->view('admin/kategori/edit_wanita/edit_gamis',$data);
            $this->load->view('admin/layout/footer');
          }

          public function action_edit_gamis(){
