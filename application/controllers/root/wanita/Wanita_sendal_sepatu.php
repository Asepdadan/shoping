...
class Wanita_sendal_sepatu extends CI_Controller {
        ...
        $this->image_lib->watermark();
         ...
         public function wanita_sendal_sepatu(){
            $data['title'] = "Produk";
            $data['data'] = $this->Model_wanita->wanitasendal_sepatu();
            $data['title'] = "Input Produk sendal_sepatu wanita";
            $data['header'] = "Produk sendal_sepatu wanita";

            $this->load->view('admin/layout/header',$data);
            $this->load->view('admin/layout/menu');
            $this->load->view('admin/kategori/wanita/sendal_sepatu_wanita',$data);
            $this->load->view('admin/layout/footer');


        }

        public function action_sendal_sepatu(){
                       ...
                       'stok' => $stok,
                        ...
                        'warna' => $warna,
                         'deskripsi' => $deskripsi,
                          ...
                          redirect('wanita_sendal_sepatu');       
            }
          }

        }

              public function deletesendal_sepatu($kode){
        ...
        public function editsendal_sepatu($kode){
         
            $data['title'] = "Input Produk sendal_sepatu wanita";
            $data['header'] = "Edit Produk sendal_sepatu";
            $data['data'] = $this->Model_wanita->getWhere($kode);
            $this->load->view('admin/layout/header',$data);
            $this->load->view('admin/layout/menu');
            $this->load->view('admin/kategori/edit_wanita/edit_sendal_sepatu',$data);
            $this->load->view('admin/layout/footer');
          }

          public function action_edit_sendal_sepatu(){
