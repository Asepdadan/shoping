...
class Wanita_celana extends CI_Controller {
        ...
        $this->image_lib->watermark();
         ...
         public function wanita_celana(){
            $data['title'] = "Produk";
            $data['data'] = $this->Model_wanita->wanitaCelana();
            $data['title'] = "Input Produk celana wanita";
            $data['header'] = "Produk celana wanita";

            $this->load->view('admin/layout/header',$data);
            $this->load->view('admin/layout/menu');
            $this->load->view('admin/kategori/wanita/celana_wanita',$data);
        ...
        public function editcelana($kode){
            ...
            $this->load->view('admin/layout/header',$data);
            $this->load->view('admin/layout/menu');
            $this->load->view('admin/kategori/edit_wanita/edit_celana',$data);
            $this->load->view('admin/layout/footer');
          }
