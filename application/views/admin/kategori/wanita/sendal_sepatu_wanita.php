    ...
    <div class="row">
        ...
        <div class="panel panel-info">
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                      <div class="col-xs-12 col-md-6">
                         <form action="<?php echo base_url().'wanita_add_sendal_sepatu'; ?>" method="POST" class="form-horizontal" role="form" enctype="multipart/form-data">
                ...
                <div class="form-group">      
                        ...
                        <input type="hidden" class="form-control" name="kategori" value="W005" required> 
                        </div>
                </div>
...
<table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
        ...
        ?>
            <tr>
                ...
                <td><a href="<?php echo base_url().'root/wanita/wanita_sendal_sepatu/editsendal_sepatu/'.$row['kode_produk']; ?>">Edit</a>  <a href="<?php echo base_url().'root/wanita/Wanita_sendal_sepatu/deletesendal_sepatu/'.$row['kode_produk']; ?>">Hapus</a></td>
            </tr>
        <?php
        $no++;
        }
