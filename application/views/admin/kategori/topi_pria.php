    ...
    <div class="row">
        ...
        <div class="panel panel-info">
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                      <div class="col-xs-12 col-md-6">
                         <form action="<?php echo base_url().'add_topi'; ?>" method="POST" class="form-horizontal" role="form" enctype="multipart/form-data">
                ...
                <div class="form-group">      
                        ...
                        <input type="hidden" class="form-control" name="kategori" value="P005"> 
                        </div>
                </div>
...
<table id="example" class="table table-striped table-bordered display" cellspacing="0" width="100%">
        ...
        ?>
            <tr>
                ...
                <td><a href="<?php echo base_url().'root/Post/edittopi/'.$row['kode_produk']; ?>"><span class="badge">Edit</span></a>  <a href="<?php echo base_url().'root/Post/deletetopi/'.$row['kode_produk']; ?>"><span class="badge">Hapus</span></a></td>
            </tr>
        <?php
        $no++;
        }
