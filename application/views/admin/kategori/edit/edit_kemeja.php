                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                      <div class="col-xs-12 col-md-6">
                         <form action="<?php echo base_url().'root/Post/action_edit_kemeja'; ?>" method="POST" class="form-horizontal" role="form" enctype="multipart/form-data">
...
<table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
        ...
        ?>
            <tr>
                <td><?php echo $no; ?></td>
                <td><a href="<?php echo base_url()?>assets/uploads/<?php echo $row['gambar']; ?>"><img src="<?php echo base_url()?>assets/uploads/<?php echo $row['gambar']; ?>" alt=""  width="80" heigth="80" /></a></td>
                <td><?php echo $row['nama']; ?></td>
                <td><?php echo $row['harga']; ?></td>
                <td><?php echo $row['kategori_id']; ?></td>
                <td><a href="<?php echo base_url().'root/Post/editkemeja/'.$row['kode_produk']; ?>">Edit</a> || <a href="<?php echo base_url().'root/Post/deletekemeja/'.$row['kode_produk']; ?>">Hapus</a></td>
            </tr>
        <?php
        $no++;
        }
